...
<head>
  ...
  <link rel="stylesheet" href="<?= get_template_directory_uri(); ?>/css/timeline.css?v=<?= filemtime(get_stylesheet_directory() . '/css/timeline.css'); ?>"> <!-- Resource style -->
  <script src="<?= get_template_directory_uri(); ?>/js/resize-header-on-scroll/js/classie.js"></script>
  <link rel="shortcut icon" type="image/x-icon" href="<?= get_template_directory_uri(); ?>/images/favicon.png" />
</head>

<body <?php body_class(); ?> id="lang-<?= ICL_LANGUAGE_CODE; ?>">

<?php if(ICL_LANGUAGE_CODE=='cs' && get_field('information_stripe_show', 554, false, 'cs') && $information_text = get_field('information_stripe_text', 554, false, 'cs')): ?>
  <div class="section" id="notice">
	   <div class="row"><?= $information_text; ?></div>
  </div>
              ...
              <div class="container clearfix">
                ...
                <div class="header-contact">
                  ...
                  <div class="language-dropdown header-language">
                    <img src="<?= get_template_directory_uri() ?>/images/lang.svg"" alt="">
                    ...
                    <div class="dropdown-content">
                      ...
                      <a href="https://nicknack.cz/it">IT</a>
                    </div>
                  </div>
...
<div id="nicknack-nav"><?php get_template_part( 'content', 'nav' ); ?></div>
